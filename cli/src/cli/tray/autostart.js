...
const APP_NAME = "e404r";
const APP_LABEL = "com.e404r.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when e404r is currently
 ...
 * SIGTERM to the running process. When the running e404r cli.js was itself
...
<dict>
    ...
    <string>/tmp/e404r.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/e404r.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `e404r.cmd` lookup that depended on the npm prefix path.

/**
 * `e404r xai video` — generate a Grok Imagine video through the local
 * e404r gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: e404r xai video --prompt "..." [options]

Generate a Grok Imagine video via your local e404r gateway
...
Options:
  ...
  --api-key <key>         e404r API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-e404r-connection-id"] || null;

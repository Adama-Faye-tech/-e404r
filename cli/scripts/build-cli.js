...
console.log("📦 Building E404R CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/e404r/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.e404r/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.e404r/runtime)");
}
console.log("");

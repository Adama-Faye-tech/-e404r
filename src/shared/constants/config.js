...
export const APP_CONFIG = {
  name: "E404R",
  description: "One Gateway. Infinite Intelligence.",
  version: pkg.version,
};

// GitHub configuration
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/e404r/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://e404r.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "e404r",
  installCmd: "npm i -g e404r",
  installCmdLatest: "npm i -g e404r@latest --prefer-online",

...
// Build TOML config for E404R (openai provider mode)
const buildE404RConfig = (baseUrl, apiKey, model) => {
...
// Detect E404R by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildE404RConfig(baseUrl, apiKey || "sk_e404r", model);

 ...
 * API. They are e404r fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic e404r variant set for a single upstream Kiro model.
 *
 ...
 * into e404r variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *

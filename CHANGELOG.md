...
- **CLI tools**: Grok Build setup — writes `[model.e404r]` to `~/.grok/config.toml`
- **GitHub Copilot**: route Claude models through Copilot's native `/v1/messages`
- **Kiro**: add GPT-5.6 model family (#2596)
- **RTK**: `X-E404R-Token-Saver` header to bypass token savers per request
...
## Docs
- README: add Indonesian E404R tutorial video (#1709)

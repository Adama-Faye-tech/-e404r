...
E404R tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

E404R cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến E404R bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến E404R
```bash
...
- Kiểm tra kết nối network đến E404R

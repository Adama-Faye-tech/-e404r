...
Tích hợp E404R với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model E404R có sẵn:
...
### Connection Failed
- Xác minh E404R đang chạy: `curl http://localhost:20128/health`

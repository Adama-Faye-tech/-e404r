...
Tích hợp E404R với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- E404R API key từ [dashboard](https://e404r.com/dashboard)
- E404R đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra E404R đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến E404R

...
Tích hợp E404R với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của E404R.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model E404R:

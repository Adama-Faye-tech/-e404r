...
Triển khai E404R trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.e404r` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/e404r`:
...
# If NOT using reverse proxy, allow E404R ports

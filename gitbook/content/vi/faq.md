...
Những câu hỏi phổ biến về E404R.

---

## E404R là gì?

**E404R là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**E404R dùng chiến lược pricing 3 tầng:**
...
## E404R có miễn phí không?

**Có, E404R hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của E404R.**
...
**E404R theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host E404R không?

**Có! E404R hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.e404r`)
...
**Có, E404R ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.e404r` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server E404R
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/e404r/blob/main/CHANGELOG.md)
- Backup `~/.e404r` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/e404r/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [e404r.com/docs](https://e404r.com/docs)

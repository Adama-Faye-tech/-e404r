...
Integrate E404R with OpenAI Codex CLI to route your OpenAI API requests through E404R's intelligent routing system.
...
E404R provides the following Codex models:
...
1. Verify your API key is correct in E404R dashboard
...
2. Check that the OpenAI provider connection is active in E404R dashboard

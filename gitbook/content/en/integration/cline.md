...
Integrate E404R with Cline VSCode extension to route your AI requests through E404R's intelligent routing system.
...
Set the base URL to your E404R endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your E404R endpoint
...
3. The key should start with `sk-e404r-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your E404R configuration
...
4. Cline will use E404R to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using E404R
...
3. Get AI-powered explanations through E404R

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use E404R to understand context and make changes
...
2. Verify your E404R instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check E404R logs for any errors
...
1. In Cline settings, set Base URL to: `https://e404r.com`
2. Make sure you have configured your API key in the E404R cloud dashboard
...
## Integration with E404R Features

### Model Routing

E404R automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, E404R automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through E404R dashboard:
- Total requests
- Token usage
- Cost per model

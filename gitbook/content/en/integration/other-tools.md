...
E404R is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

E404R provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to E404R using these settings:

**Local E404R:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any E404R model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to E404R
```bash
...
- Check network connection to E404R

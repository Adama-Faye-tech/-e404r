...
Integrate E404R with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- E404R API key from [dashboard](https://e404r.com/dashboard)
- E404R running (local or cloud)
...
### 2. Add E404R Model Configuration
...
3. Choose your preferred E404R model
...
- Check network latency to E404R

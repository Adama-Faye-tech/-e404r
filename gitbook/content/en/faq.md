...
Common questions about E404R.

---

## What is E404R?

**E404R is an AI model router that maximizes your subscription value and minimizes costs.**
...
**E404R uses a 3-tier pricing strategy:**
...
**Yes, E404R itself is 100% free and open source.**
...
**Yes! This is E404R's core feature.**
...
**E404R tracks quota in real-time for all providers:**
...
## Can I self-host E404R?

**Yes! E404R supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.e404r`)
...
**Yes, E404R prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.e404r` (or custom `DATA_DIR`)
- No data sent to E404R servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/e404r/blob/main/CHANGELOG.md)
- Backup `~/.e404r` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/e404r/blob/main/CONTRIBUTING.md) for details.

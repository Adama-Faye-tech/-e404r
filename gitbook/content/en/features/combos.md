...
Combos are **custom fallback chains** that you create in the dashboard. Instead of using a single model, you define a sequence of models that E404R tries in order.
...
E404R automatically tries each model in sequence until one succeeds.
...
When limit reached, E404R skips paid models and uses free tier only.

...
Guía detallada de instalación de E404R con consejos de solución de problemas.
...
Instala E404R globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `e404r`
- ✅ Auto-actualizaciones con `npm update -g e404r`
...
3. Se crea el directorio de datos en `~/.e404r`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/e404r'
```
...
**Problema:** E404R usa demasiada RAM
...
```bash
docker pull e404r/e404r:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v e404r-data:/root/.e404r \
  --name e404r \
  e404r/e404r:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con e404r
```
...
- **Sitio web**: [e404r.com](https://e404r.com)

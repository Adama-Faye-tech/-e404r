...
Integra E404R con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de E404R.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- E404R ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de E404R:
...
**Para E404R en la nube:**
```
https://e404r.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de E404R
...
4. Cline usará E404R para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando E404R
...
3. Obtén explicaciones potenciadas por IA a través de E404R

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará E404R para entender el contexto y hacer cambios
...
1. Verifica que E404R esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de E404R esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de E404R para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de E404R en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://e404r.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de E404R
...
## Integración con características de E404R

### Enrutamiento de modelos

E404R enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, E404R automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de E404R:

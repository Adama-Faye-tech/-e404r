...
E404R es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

E404R proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a E404R usando estas configuraciones:

**E404R local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de E404R (cc/*, cx/*, glm/*, etc.)
```

**E404R en la nube:**
```
Base URL: https://e404r.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de E404R (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a E404R
```bash
# Verifica si E404R está corriendo
...
**Solución:**
- Verifica que E404R esté corriendo
...
- Verifica la conexión de red a E404R

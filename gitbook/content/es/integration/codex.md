...
Integra E404R con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de E404R.
...
E404R proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de E404R
...
1. Verifica que el nombre del modelo coincida con tu configuración de E404R
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de E404R
...
```bash
export OPENAI_BASE_URL="https://e404r.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de E404R.

...
Problemas comunes y soluciones al usar E404R.
...
1. **Refresh automático (por defecto):**
   E404R refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si E404R está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep e404r
...
- **GitHub Issues:** [github.com/decolua/e404r/issues](https://github.com/decolua/e404r/issues)

...
Preguntas comunes sobre E404R.

---

## ¿Qué es E404R?

**E404R es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**E404R usa una estrategia de precios de 3 niveles:**
...
**Sí, E404R en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de E404R.**
...
**E404R rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿E404R funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de E404R:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://e404r.com/v1
...
## ¿Puedo auto-hospedar E404R?

**¡Sí! E404R soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.e404r`)
...
**Sí, E404R prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.e404r` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de E404R
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/e404r/blob/main/CHANGELOG.md)
- Respalda `~/.e404r` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/e404r/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/e404r/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/e404r.git
   cd e404r
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/e404r/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [e404r.com/docs](https://e404r.com/docs)

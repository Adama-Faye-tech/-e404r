...
E404RをClaude Code CLIと統合し、AnthropicのAPIリクエストをE404Rのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはE404Rモデルにマッピングされる以下のモデルエイリアスをサポート:
